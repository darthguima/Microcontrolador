...
wrx:    LDR R2, [R0, #UART_FR] ; status da UART
        ...
        CMP R1, #0x0D //Equivalente a \r
        BEQ trans //Chama a subrotina de transmissão
...
trans:
        LDR R2,=REPLY  //Sistemas Microcontrolados\r\n
        MOV R3, #CONST_REPLY //Tamanho da string
...
wtx:
        ...
        LDR R5, [R2]  // Le letra por letra da string
        STR R5, [R0]
        
        ADD R2, R2, #1 //Caminha pela string
        SUB R3, R3, #1
